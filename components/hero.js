          ...
          <div className="flex flex-col gap-y-8 md:gap-y-14 items-center">
            <div className="flex flex-col gap-y-8 items-start ">
              ...
              <p className="p md:large w-[20rem] md:w-[32rem] leading-8">
                Depuis de nombreuses années, WD Toitures est votre partenaire de
                confiance en Belgique pour tous vos besoins en matière de
                couverture et de toitures. Fort de notre expertise et de notre
                engagement envers l'excellence, nous proposons des solutions
                complètes et durables pour vos projets résidentiels, commerciaux
                et industriels.
              </p>
              <p className="p md:large w-[20rem] md:w-[32rem] leading-8">
            ...
            <div>
              ...
              >
                <p className="p small">
                  ...
                  d'isolation et de finition. Notre équipe spécialisée travaille
                  avec dévouement pour donner vie à vos projets, en combinant
                  fonctionnalité et esthétique pour un résultat parfait. Ce qui
                  nous distingue ? Notre passion pour le métier et notre
                  engagement à dépasser vos attentes, quelle que soit la
                  complexité de la mission.
                </p>
                <p className="p small">
                  Nous intervenons à Bruxelles, dans le Brabant wallon et les
                  régions avoisinantes et proposons des solutions complètes pour
                  toits, de la petite maintenance aux rénovations de grande
                  envergure. Grâce à notre vaste expérience dans le secteur,
                  nous garantissons un service de haute qualité, avec une
                  attention au détail et au savoir‑faire, aussi bien pour les
                  toits plats que inclinés.
                </p>
                <p className="p small">
                  Notre expertise nous permet d'aborder tous les aspects de
                  votre toit, de la construction à l'installation des finitions
                  et accessoires. Nous travaillons avec différents types de
                  couvertures, comme les tuiles, l'ardoise, le zinc et
                  l'aluminium, et proposons également des installations
                  d'isolation et de fenêtres de toit.
                </p>
                <p className="p small">
                  Quel que soit votre projet, nous fournissons un service sur
                  mesure parfaitement adapté à vos souhaits. Faites confiance à
                  notre équipe pour un toit durable, sûr et parfaitement fini !
                </p>
              </div>
              {/* MOBILE */}
              <div
              ...
              >
                <p className="p small">
                  ...
                  finition. Notre équipe travaille avec dévouement pour combiner
                  fonctionnalité et esthétique pour un résultat parfait. Ce qui
                  nous distingue ? Notre passion et notre engagement à toujours
